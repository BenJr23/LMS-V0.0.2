...
import { setStudentRole } from '@/app/_actions/setStudentRole';  // <- use your updated server action
...
export default function Home() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Step 2: Fetch the student data from your API
      ...
      // Step 4: Set Clerk metadata using server action
      ...
      // Step 5: Redirect after successful role setup
      ...
      <div className="absolute right-0 top-0 h-full w-full md:w-[450px] bg-white shadow-lg">
        <div className="h-full flex flex-col justify-center p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-red-800">Student Portal</h1>
            <p className="text-gray-600 text-sm">Sign in to access your student account</p>
          </div>
